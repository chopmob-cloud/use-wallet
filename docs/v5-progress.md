...
- [ ] **Upgrade Web3Auth SDK** from v9 to v10. Significant API changes: SDK unification, `@web3auth/base-provider` deprecated, chain config moved to dashboard. Requires adapter rewrite. Update adapter options type accordingly.
