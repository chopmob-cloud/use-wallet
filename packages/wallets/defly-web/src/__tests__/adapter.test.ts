...
type TestableDeflyWebAdapter = DeflyWebAdapter & {
...
describe('DeflyWebAdapter', () => {
  let wallet: DeflyWebAdapter
  ...
  beforeEach(() => {
    ...
    vi.spyOn(DeflyWebAdapter.prototype as TestableDeflyWebAdapter, '_disable')
      .mockReset()
      .mockImplementation(() =>
        Promise.resolve({
  ...
  describe('signing transactions', () => {
    ...
    beforeEach(async () => {
      vi.spyOn(DeflyWebAdapter.prototype as TestableDeflyWebAdapter, '_signTransactions')
        .mockReset()
        .mockImplementation(() =>
          Promise.resolve({
            providerId: DEFLY_WEB_PROVIDER_ID,
